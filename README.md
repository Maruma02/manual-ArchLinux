# manual-ArchLinux
! Данный гайд я делал скорее для себя чем для кого-то, но если он кому то поможет мне будет очень приятно. Писал его основываясь на этом руководстве: https://github.com/Vlador1337/Arch-Linux-Install-Guide-RU но в некоторые моменты у меня с ним возникали трудности пожтому и сделал этот мануал.
